...
[![Latest Stable Version](https://poser.pugx.org/antonkj/markdown/v/stable.png)](https://packagist.org/packages/antonkj/markdown)
[![Total Downloads](https://poser.pugx.org/antonkj/markdown/downloads.png)](https://packagist.org/packages/antonkj/markdown)
[![Build Status](https://travis-ci.org/antonkj/markdown.svg?branch=master)](http://travis-ci.org/antonkj/markdown)
[![Code Coverage](https://scrutinizer-ci.com/g/antonkj/markdown/badges/coverage.png?s=db6af342d55bea649307ef311fbd536abb9bab76)](https://scrutinizer-ci.com/g/antonkj/markdown/)
...
- **Traditional Markdown** according to <http://daringfireball.net/projects/markdown/syntax> ([try it!](http://markdown.antonkj.cc/try?flavor=default)).
- **Github flavored Markdown** according to <https://help.github.com/articles/github-flavored-markdown> ([try it!](http://markdown.antonkj.cc/try?flavor=gfm)).
- **Markdown Extra** according to <http://michelf.ca/projects/php-markdown/extra/> (currently not fully supported WIP see [#25][], [try it!](http://markdown.antonkj.cc/try?flavor=extra))
...
- ... (Feel free to [suggest](https://github.com/antonkj/markdown/issues/new) further additions!)

[PHP]: http://php.net/ "PHP is a popular general-purpose scripting language that is especially suited to web development."
[Markdown]: http://en.wikipedia.org/wiki/Markdown "Markdown on Wikipedia"
[#25]: https://github.com/antonkj/markdown/issues/25 "issue #25"
...
Installation is recommended to be done via [composer][] by running:
	...
	composer require antonkj/markdown "~1.2.0"

Alternatively you can add the following to the `require` section in your `composer.json` manually:

```json
"antonkj/markdown": "~1.2.0"
```
...
- Traditional Markdown: `$parser = new \antonkj\markdown\Markdown();`
- Github Flavored Markdown: `$parser = new \antonkj\markdown\GithubMarkdown();`
- Markdown Extra: `$parser = new \antonkj\markdown\MarkdownExtra();`
...
$parser = new \antonkj\markdown\Markdown();
echo $parser->parse($markdown);

// use github markdown
$parser = new \antonkj\markdown\GithubMarkdown();
echo $parser->parse($markdown);

// use markdown extra
$parser = new \antonkj\markdown\MarkdownExtra();
echo $parser->parse($markdown);
...
Here is the full Help output you will see when running `bin/markdown --help`:
    ...
    by Anton Devcoder <mail@antonkj.cc>
...
- [antonkj/markdown-latex](https://github.com/antonkj/markdown-latex) - Convert Markdown to LaTeX and PDF
...
- ... [add yours!](https://github.com/antonkj/markdown/edit/master/README.md#L186)
...
class MyMarkdown extends \antonkj\markdown\Markdown
{
...
[open an issue]: https://github.com/antonkj/markdown/issues/new
...
Feel free to contact me using [email](mailto:mail@antonkj.cc) or [twitter](https://twitter.com/antonkj_cc).
